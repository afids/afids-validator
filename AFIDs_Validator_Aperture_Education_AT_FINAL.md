...
Following the CRediT taxonomy: **Conceptualization** — J.C.L., A.R.K., A.T., G.G.; **Software** — A.T., J.K., T.K., G.G., J.C.L. (validation engine and reference-template pipeline) and A.T. (AI-guided learning mode and rater-reliability calibration); **Formal analysis** and **Visualization** — A.T.; **Data curation** — A.T., J.K., T.K., G.G., M.A., A.R.K., J.C.L.; **Writing – original draft** — A.T., J.C.L., A.R.K.; **Writing – review & editing** — all authors; **Supervision** — J.C.L., A.R.K.; **Funding acquisition** — J.C.L., A.R.K.; **Investigation / Validation** (platform testing and pedagogical design) — D.B., A.Th., J.T., M.A. Initials: A.T. (Alaa Taha), D.B. (Dhananjhay Bansal), A.Th. (Arun Thurairajah), J.T. (Jaime Thrower), J.K. (Jason Kai), T.K. (Tristan Kuehn), G.G. (Greydon Gilmore), M.A. (Mohamad Abbass), A.R.K. (Ali R. Khan), J.C.L. (Jonathan C. Lau). *\[Scaffolded from the author contributions of Taha et al. (2023) and the afids-validator repository history; the role assignments for D.B., A.Th., and J.T., and the precise per-role membership, require confirmation by the author team.\]*
